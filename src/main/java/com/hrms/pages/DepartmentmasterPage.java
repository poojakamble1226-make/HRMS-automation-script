 ...
 */
public class DepartmentmasterPage extends BasePage {

    public DepartmentmasterPage(WebDriver driver, int waitSeconds) {
        super(driver, waitSeconds);
    }

    // ── Locators ─────────────────────────────────────────────
    private final By addDepartmentBtn =
            By.xpath("//button[contains(., 'Add Department')]");

    private final By departmentNameField =
